...
void level4(){
  ...
  int duration[] = {408,408,408, 408,408,408,408};
  if(digitalRead(button1Pin) ==HIGH){
    ...
    for(int i=0;i<7;i++){
      ...
      //Ali Mujtaba, Arsalan. “ ArsalanAliMujtaba/Radioactive-Engineer .” GitHub, Arsalan Ali Mujtaba, 3 May 2020, https://github.com/ArsalanAliMujtaba/Radioactive-Engineer/blob/master/Coffin%20Dance.ino .
    // it is the song from the coffin guys meme
     void level5(){
